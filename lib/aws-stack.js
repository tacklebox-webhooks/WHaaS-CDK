...
class IamStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const dbSetupLambdaPolicyStatement = new iam.PolicyStatement({
      effect: "Allow",
      actions: [
        "sts:AssumeRole",
    ...
    const dbSetupLambdaPolicy = new iam.Policy(this, "dbSetupLambdaPolicy", {
      policyName: "dbSetupLambdaPolicy",
      statements: [
        dbSetupLambdaPolicyStatement
      ]
    });
    ...
    const lambdaVpcRole = new iam.Role(this, "vpcRole", {
      ...
      inlinePolicies: [dbSetupLambdaPolicy],
      roleName: "Tacklebox_lambdaVPCRole",
    });
    
    lambdaVpcRole.attachInlinePolicy(dbSetupLambdaPolicy);
