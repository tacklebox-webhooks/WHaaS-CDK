...
class AwsStack extends cdk.Stack {
  ...
  constructor(scope, id, props) {
    ...
    //   this,
    //   "dbSetupSecurityGroupF26835D5-security-group",
    //   {
    //     vpc,
    //   }
    // );

    const credentials = rds.Credentials.fromGeneratedSecret("syscdk");
    const vpcSubnets = {
    ...
    const db = new rds.DatabaseInstance(this, "teamfourdb", {
      ...
      credentials, // Optional - will default to 'admin' username and generated password
      vpc,
      vpcSubnets,
      ...
      //     fromPort: this.dbInstanceEndpointPort,
      //     toPort: this.dbInstanceEndpointPort,
      //   }),
      // }),
    ...
    const logsLambdaIntegration = new apigateway.LambdaIntegration(logsLambda);
    ...
    const api = new apigateway.RestApi(this, "kth-api");
